...
export const Arrow = ({ color, size = 80 }) => (
  <svg
    version="1.1"
  ...
  >
    <g strokeLinecap="round">
      ...
      <g transform="translate(71.54317543189973 10.981556692346885) rotate(0 -30.8761326969601 29.399042489323847)">
        <path d="M-60.87 59.42 L-50.49 52.9 L-46.69 65.8 L-63.12 57.84" stroke="none" strokeWidth="0" fill="currentColor" fillRule="evenodd"></path>
        <path
